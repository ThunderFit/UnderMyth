...
const MapToState = (state, context) => {
    ...
    compState['skillExperience'] = !_.isUndefined(state.skills.skills[context.skillTree.id]) ? state.skills.skills[context.skillTree.id].exp : 0;
    compState['skillInfoState'] = !_.isUndefined(state.skills.skills[context.skillTree.id]) ? state.skills.skills[context.skillTree.id] : {};
    return compState;
};
